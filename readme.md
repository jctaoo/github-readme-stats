...
*   `EXCLUDE_OWNER`: A comma-separated list of repository owners (organizations or users) whose repositories will be excluded from top languages cards on your instance. This allows excluding all repositories from specific owners without having to list each repository individually.
